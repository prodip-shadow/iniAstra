  ...
  constructor(e) {
    ...
    this.onBeforeCompile = (e) => {
      try {
        ...
        console.warn('Shader compilation warning:', err);
      }
    };
  }
}
...
class Z extends d {
  constructor(e, t = {}) {
    try {
      ...
      console.error('Ballpit initialization error:', err);
      throw err;
    }
  }
  #S() {
...
const Ballpit = ({ className = '', followCursor = true, ...props }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error('Error initializing Ballpit:', err);
    }
