...
export default function CTASection() {
  return (
    <section
      id="contact"
      className="bg-slate-950 py-12 sm:py-16 md:py-20 lg:py-24"
    >
          ...
          <div className="grid gap-8 sm:gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <p className="max-w-xl text-sm sm:text-base leading-6 sm:leading-7 text-gray-300 md:text-lg">
            ...
            <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
              <article className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] text-gray-400">
                  Typical response
                </p>
                <div className="mt-2 sm:mt-3 text-2xl sm:text-3xl font-semibold text-white">
                  24h
                </div>
                <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-gray-400">
